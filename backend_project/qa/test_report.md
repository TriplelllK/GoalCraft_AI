...
[
  {
    ...
    "count": 3,
    "sample_titles": [
      "До 30.06 обеспечить доля целей, привязанных к KPI подразделения, не ниже 85% за счет за счет систематического согласования целей с руководителями подразделений.",
  ...
  },
  {
    ...
    "sample_titles": [
      ...
      "До 30.06 обеспечить средний срок закрытия вакансий не более 30 рабочих дней за счет за счет оптимизации воронки подбора и автоматизации скрининга кандидатов."
    ]
  },
  {
    ...
    "sample_titles": [
      "До 30.06 сократить средний срок согласования HR-заявок с 5 до 3 рабочих дней за счет цифровизации маршрута согласования.",
      "До 30.06 обеспечить доля сотрудников, прошедших обязательное обучение, не ниже 97% за счет за счет автоматизации напоминаний и еженедельного контроля статусов."
    ]
  },
  {
    ...
    "sample_titles": [
      "До 30.06 сократить средний срок согласования HR-заявок с 5 до 3 рабочих дней за счет цифровизации маршрута согласования.",
      "До 30.06 обеспечить доля автоматизированных HR-отчётов не менее 80% за счет за счет внедрения дашбордов и автоматизации сбора данных из HR-систем."
    ]
  }
]
```
